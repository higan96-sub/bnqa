...
//    つづきをよむ
    ...
    $(window).load(function () {
        ...
        if (typeof asinCode !== "undefined" && asinCode !== null) {
            $.ajax({
                type: "GET",
                url: "/app_dev.php/item/similarities",
                data: {
                    asin_code: asinCode
                },
                dataType: 'json'
...
//                $('.misprint-form').slideUp();
    ...
    $('.load-to-read').click(function () {
        if ($(this).hasClass('disabled') == false) {
            ...
            $.ajax({
                type: "GET",
                url: "/app_dev.php/inner/reports/line",
                data: {
    ...
    $('.load-items').click(function () {
        if ($(this).hasClass('disabled') == false) {
            ...
            $.ajax({
                type: "GET",
                url: "/app_dev.php/user/homeSidebar/following/",
                data: {
                    page: itemPage
                },
                dataType: 'json'
...
function followOrRemove() {
    $('.js-action-follow-item').click(function () {
        ...
        if ($(this).hasClass('following')) {
            $.ajax({
                type: "POST",
                url: "/app_dev.php/following/remove/item",
                data: {
                    asinCode: asinCode
                },
                dataType: 'json',
            ...
            if ($(this).hasClass('btn-info') == false) {
                ...
                $.ajax({
                    type: "POST",
                    url: "/app_dev.php/following/create/item",
                    data: {
                        asinCode: asinCode
                    },
                    dataType: 'json',
...
function bookmark() {
    $('a.js-action-bookmark').click(function () {
        ...
        if ($(this).hasClass('bookmarked')) {
            $.ajax({
                type: "POST",
                url: "/app_dev.php/reportbookmark/delete",
                data: {
                    report: report
                },
                dataType: 'json',
            ...
            $.ajax({
                type: "POST",
                url: "/app_dev.php/reportbookmark/create",
                data: {
                    report: report
                },
                dataType: 'json',
